...
class ImitationTask(object):
    ...
    def _calc_reward_root_pose(self):
        ...
        if self._r_velocity is not None:
    ...
    def _calc_reward_root_velocity(self):
        ...
        if self._r_velocity is not None:
            ...
            root_vel_ref = pose3d.VECTOR3_X * self._r_velocity

            root_ang_vel_ref = pose3d.VECTOR3_X * 0
    ...
    """
        ...
        # if self._r_velocity is not None:
        #     # print("does pos work?")
        #     pos = pose3d.VECTOR3_X * self._get_motion_time() * self._r_velocity
        #     # print("does rot work?")
        #     rot = transformations.quaternion_about_axis(0, pose3d.VECTOR3_X)
        #     # print("current velocity is " + str(pose[0]))
        #     # POS_SIZE = 3
        #     # ROT_SIZE = 4
        #     # VEL_SIZE = 3
        #     # ANG_VEL_SIZE = 3
        #     # print("does pose work?")
        #
        #     pose = np.empty(19,
        #                     dtype=float)
        # #
        #     # print(pose)
        #     motion.set_frame_root_rot(rot, pose)
        #     motion.set_frame_root_pos(pos, pose)
    ...
    """
        ...
        # if self._r_velocity is not None:
        #
        #     pos = pose3d.VECTOR3_X * self._r_velocity
        #
        #     rot = pose3d.VECTOR3_X * 0
        #
        #
        #     vel = np.empty(18,
        #                     dtype=float)
        #
        #     motion.set_frame_root_vel(rot, vel)
        #     motion.set_frame_root_ang_vel(pos, vel)
